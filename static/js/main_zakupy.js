...
//            const formData = new FormData();
//            formData.append('opis', this.currentTool.opis);
//            formData.append('stan_minimalny', this.currentTool.stan_minimalny !== undefined ? this.currentTool.stan_minimalny : 5);
//            formData.append('stan_maksymalny', this.currentTool.stan_maksymalny !== undefined ? this.currentTool.stan_maksymalny : 20);
//
//            if (this.currentTool.podkategoria_id) {
//                formData.append('podkategoria_id', this.currentTool.podkategoria_id);
//            }
...
//            const formData = new FormData();
//            formData.append('opis', this.currentTool.opis);
//            formData.append('stan_minimalny', this.currentTool.stan_minimalny || 0);
//            formData.append('stan_maksymalny', this.currentTool.stan_maksymalny || 10);
//
//            if (this.currentTool.podkategoria_id) {
//                formData.append('podkategoria_id', this.currentTool.podkategoria_id);
//            }
