                        ...
                        <div class="panel-body">
                            ...
                            <div v-else>
                                <div class="email-config-table">
                                    ...
                                    <div class="config-row"><span class="config-label">Adres DW 1 (dostawca)</span><span>{{ emailConfig.email_dw || '-' }}</span></div>
                                    <div class="config-row"><span class="config-label">Adres DW 2 (szef)</span><span>{{ emailConfig.email_dw2 || '-' }}</span></div>
