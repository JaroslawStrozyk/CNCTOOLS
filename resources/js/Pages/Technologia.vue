    ...
    <div class="magazyn-app">
        ...
        <header class="magazyn-header">
            ...
            <div class="header-buttons">
                <button class="btn-demand-card" title="Karta zapotrzebowania dla nowej pozycji">
            ...
            <div class="tools-panel">
                ...
                <div class="panel-body">
                    ...
                    >
                        ...
                        <Column header="" style="width: 50px; text-align: center;">
                            <template #body="{ data }">
                                <button class="btn-demand-card-row" @click.stop title="Karta zapotrzebowania">
                                    <i class="pi pi-file-plus"></i>
                                </button>
                            </template>
                        </Column>
