...
from .views_inertia import (
    ...
    uzycie_view as uzycie_inertia_view,
...
router.register(r'numery-katalogowe-dostawcow', views.NumerKatalogowyDostawcyViewSet, basename='numer-katalogowy-dostawcy')
...
urlpatterns = [
    ...
    path('uzycie/', uzycie_inertia_view, name='uzycie'),
