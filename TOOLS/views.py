...
#             calkowita_ilosc=Sum(
#                 Case(
#                     When(~Q(egzemplarze__stan='uszkodzone'), then='egzemplarze__ilosc_w_komplecie'),
#                     default=Value(0),
#                     output_field=IntegerField()
#                 )
#             )
...
#             )
#
#             # Jeśli uszkodzone, utwórz wpis w tabeli uszkodzeń
#             if stan_po_zwrocie == 'uszkodzone':
#                 Uszkodzenie.objects.create(
#                     egzemplarz=historia.egzemplarz,
#                     opis_uszkodzenia=request.data.get('uwagi', 'Uszkodzenie podczas użycia'),
#                     pracownik=historia.pracownik
#                 )
#
#             serializer = self.get_serializer(historia)
